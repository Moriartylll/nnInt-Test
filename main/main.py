...
class main(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("main")  # TODO: make this more human readable by adding spaces
...
class mainWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: Optional[mainParameterNode]) -> None:
        """
